			...
			<div className="row g-4 px-5 row-cols-1 row-cols-lg-3 m-5">
				<div className="col d-flex align-items-start px-5">
					...
					<div className="d-flex flex-column justify-content-start">
						...
						<p className="About-p text-justify">Es una de las mejores opciones en tratamientos faciales, corporales y depilación, además te ofrecemos productos de la mejor calidad para el cuidado de tu piel.</p>
					</div>
				</div>
				...
				<div className="col d-flex align-items-start px-5">
					...
					<div className="d-flex flex-column justify-content-start">
						...
						<p className="About-p text-justify">Mejorar el bienestar de nuestros clientes con servicios de la más alta calidad. Nuestros especialistas están altamente calificados en cada uno de los tratamientos que ofrecemos.</p>
					</div>
				</div>
				<div className="col d-flex align-items-start px-5">
					<div className="text-body-emphasis d-inline-flex align-items-center justify-content-center flex-shrink-0 me-3">
					...
					<div className="d-flex flex-column justify-content-start">
						...
						<p className="About-p text-justify">Ofrecemos tratamientos faciales y corporales, de la mas alta calidad, servicio y resultados además te ofrecemos productos de la mejorar la calidad del cuidado de tu piel.</p>
					</div>
				</div>
				{/* ... */}
			</div>
