			...
			<div class="row g-4 px-5 row-cols-1 row-cols-lg-3">
				<div class="col d-flex align-items-start my-5 px-3">
					...
					<div>
						...
						<p className="About-p">
							Es una de las mejores opciones en tratamientos faciales, corporales y depilación, además te
							ofrecemos productos de la mejor calidad para el cuidado de tu piel.
						</p>
					</div>
				</div>
				<div class="col d-flex align-items-start my-5 px-3">
					...
					<div>
						...
						<p className="About-p">
							Nuestra misión es mejorar el bienestar de nuestros clientes con servicios de la más alta
							calidad. Nuestros especialistas están altamente calificados en cada uno de los tratamientos
							que ofrecemos.
						</p>
					</div>
				</div>
				<div class="col d-flex align-items-start my-5 px-3">
					...
					<div>
						...
						<p className="About-p">
							Somos una de las mejores compañías en ofrecer tratamientos faciales y corporales, de la mas
							alta calidad, servicio y resultados además te ofrecemos productos de la mejorar la calidad
