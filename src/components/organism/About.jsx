	...
	return (
		<Container className="my-4">
			<Row className="justify-content-center">
				<Col md={4} className="mb-5 mt-5 px-5">
					<div className="circle-container mb-4 text-center mb-2">
						<div className="circle" style={{ backgroundColor: 'var(--color-primary)', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', width: '80px', height: '80px', marginBottom: '5px' }}>
