				...
				<div className="col-md-7 col-lg-8" >
					<form className="needs-validation" noValidate onSubmit={handleSubmit}>
						<div className="row g-3">
							...
							<div className="col-sm-4">
								...
								<div className="input-group has-validation">{/* ... */}
									<input type="text" className={`form-control custom-border-color-orange ${nombresError ? 'is-invalid' : ''}`}
										id="nombres" placeholder="Nombre(s)" required="" onChange={handleChange} />
							...
							<div className="col-sm-4">
								...
								<div className="input-group has-validation">{/* ... */}
									<input type="text" className={`form-control custom-border-color-orange ${apellidosError ? 'is-invalid' : ''}`}
										id="apellidos" placeholder="Apellidos" required="" onChange={handleChange} />
							...
							<div className="col-sm-4">
								...
								<div className="input-group has-validation">
									<span className="input-group-text bg-white custom-border-color-orange"><img src={telefono} alt="telefono" className="img-form" /></span>
									<input type="text" className={`form-control custom-border-color-orange ${telefonoError ? 'is-invalid' : ''}`} id="telefono"
										placeholder="Teléfono" required="" onChange={handleChange} />
						...
						<div className="text-center">
							<button className={`btn btn-primary btn-lg-8 mt-4 w-50 ${formValid ? '' : 'disabled'}`} type="submit" style={{ backgroundColor: formValid ? '' : '#CCCCCC' }}
								disabled={!formValid}>
								RESERVAR
							</button>
						</div>
