    ...
    <div className="container py-4">
      <ul className="nav nav-pills justify-content-center mb-4">
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'all' ? 'active' : ''}`}
        ...
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'sala-1' ? 'active' : ''}`}
            onClick={() => handleFilter('sala-1')}
          >
            Sala 1
          </button>
        </li>
        ...
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'sala-2' ? 'active' : ''}`}
            onClick={() => handleFilter('sala-2')}
          >
            Sala 2
          </button>
        </li>
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'sala-3' ? 'active' : ''}`}
            onClick={() => handleFilter('sala-3')}
          >
            Sala 3
          </button>
        </li>
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'sala-4' ? 'active' : ''}`}
            onClick={() => handleFilter('sala-4')}
          >
            Sala 4
          </button>
        </li>
        <li className="nav-item">
          <button
            className={`nav-link btn ${filter === 'sala-5' ? 'active' : ''}`}
            onClick={() => handleFilter('sala-5')}
          >
            Sala 5
          </button>
        </li>
