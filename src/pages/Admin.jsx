		...
		<>
			...
			<section className="container cards pt-5 mb-5" id="container">
				{solicitudes.map((solicitud) => (
					<div className="row">
						<CitasCard _id={solicitud._id} nombres={solicitud.nombres} apellidos={solicitud.apellidos} telefono={solicitud.telefono} fecha={solicitud.fecha} hora={solicitud.hora} tratamiento={solicitud.tratamiento} comentarios={solicitud.comentarios} />
					</div>
				))}
			</section>
			<Footer></Footer>
